		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMemberCallAccess().getGroup_1(), "rule__MemberCall__Group_1__0");
					put(grammarAccess.getMemberCallAccess().getGroup_1_0(), "rule__MemberCall__Group_1_0__0");
					put(grammarAccess.getMemberCallAccess().getGroup_1_0_0(), "rule__MemberCall__Group_1_0_0__0");
					...
					put(grammarAccess.getAssignmentAccess().getTargetAssignment_0_1(), "rule__Assignment__TargetAssignment_0_1");
					put(grammarAccess.getAssignmentAccess().getValueAssignment_0_3(), "rule__Assignment__ValueAssignment_0_3");
					put(grammarAccess.getAssignmentAccess().getOpAssignment_1_1_0_0_1(), "rule__Assignment__OpAssignment_1_1_0_0_1");
					...
					put(grammarAccess.getMemberCallAccess().getFeatureAssignment_1_0_0_1(), "rule__MemberCall__FeatureAssignment_1_0_0_1");
					put(grammarAccess.getMemberCallAccess().getValueAssignment_1_1(), "rule__MemberCall__ValueAssignment_1_1");
